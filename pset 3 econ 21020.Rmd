...
Showing (4):
$$\displaystyle \min_{\alpha,\beta \in \mathbb{R}} E((E(Y|X)-(\alpha + X\beta))^2)$$
...
Showing (5):
$\displaystyle \min_{\alpha,\beta \in \mathbb{R}} E((Y-(\alpha + X\beta))^2)$
